...
// Add global auth to the collection root
collection.auth = {
  "type": "bearer",
  "bearer": [
    {
...
// Recreate masters folder but without manual Auth headers, as it inherits from collection
const mastersFolder = {
...
console.log("Postman collection updated with global auth.");
